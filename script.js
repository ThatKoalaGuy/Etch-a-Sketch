...
div.style.cssText = "border-color: aqua; border-style: solid; border-width: 1px;";
...
button.addEventListener('click', () =>{
    sideSize = Number(prompt("Input an int for a side lenght, it must be 100 or less", 50));
